...
export const SocialImages: BentoItem[] = [
  {
    id: 1,
    image: "/imgs/images/serve1.png",
    className: "col-span-2 row-span-1 md:col-span-2 md:row-span-2",
  },
  {
    id: 2,
    image: "/imgs/images/serve2.png",
    className: "md:col-span-2 md:row-span-1",
  },
  {
    id: 3,
    image: "/imgs/images/serve3.png",
    className: "col-span-1 row-span-2 md:col-span-1 md:row-span-2",
  },
  {
    id: 4,
    image: "/imgs/images/serve4.png",
    className: "md:col-span-1 md:row-span-2",
  },
  {
    id: 5,
    image: "/imgs/images/serve5.png",
    className: "col-span-1 row-span-2 md:col-span-1 md:row-span-1",
  },
  {
    id: 6,
    image: "/imgs/images/serve6.png",
    className: "md:col-span-1 md:row-span-1",
  },
  {
    id: 7,
    image: "/imgs/images/serve7.png",
    className: "md:col-span-2 md:row-span-1",
  },
  {
    id: 8,
    image: "/imgs/images/serve8.png",
    className: "col-span-2 row-span-1 md:col-span-2 md:row-span-1 ",
  },
  {
    id: 9,
    image: "/imgs/images/serve9.png",
    className: "md:col-span-2 md:row-span-1",
  },
  {
    id: 10,
    image: "/imgs/images/serve10.png",
    className: "col-span-1 row-span-2 md:col-span-1 md:row-span-2",
  },
  {
    id: 11,
    image: "/imgs/images/serve11.png",
    className: "md:col-span-1 md:row-span-2",
  },
  {
    id: 12,
    image: "/imgs/images/serve12.png",
    className: "col-span-1 row-span-2 md:col-span-1 md:row-span-1",
  },
  {
    id: 13,
    image: "/imgs/images/serve13.png",
    className: "md:col-span-1 md:row-span-1",
  },
  {
    id: 14,
    image: "/imgs/images/serve14.png",
    className: "md:col-span-2 md:row-span-1",
  },
  {
    id: 15,
    image: "/imgs/images/serve15.png",
    className: "col-span-2 row-span-1 md:col-span-2 md:row-span-1 ",
  },
  {
    id: 16,
    image: "/imgs/images/serve16.png",
    className: "md:col-span-1 md:row-span-1",
  },
  {
    id: 17,
    image: "/imgs/images/serve17.png",
    className: "md:col-span-2 md:row-span-1",
  },
  {
    id: 18,
    image: "/imgs/images/serve18.png",
